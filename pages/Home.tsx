    ...
    <Layout>
      <div className="max-w-5xl mx-auto px-12 py-24 space-y-24">
        ...
        <section className="space-y-6">
          ...
          <p className="text-4xl text-white/50 font-light leading-snug">
        ...
        <section className="space-y-8 max-w-2xl">
          ...
          <div className="space-y-2 font-mono text-xs tracking-widest text-white/30 uppercase border-l border-white/10 pl-6">
        ...
        <section className="space-y-12">
          <div className="space-y-4">
            <h2 className="text-sm font-mono uppercase tracking-[0.4em] text-secondary">The Execution Stack</h2>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
            <div className="space-y-2 font-mono text-[11px] text-white/40 uppercase leading-relaxed py-4 border border-white/5 p-8 bg-white/[0.01]">
        ...
        <section className="space-y-10 py-12 border-t border-white/5">
          <div className="space-y-4">
            <h2 className="text-sm font-mono uppercase tracking-[0.4em] text-secondary">Hardware Layer</h2>
            <p className="text-base text-white/60 leading-relaxed max-w-xl">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {/* Anchor Band */}
            <a href="#/origin" className="group border border-white/10 p-8 hover:border-[#BFA35B]/50 transition-all bg-white/[0.01] hover:bg-white/[0.02]">
              <div className="space-y-6">
                <div className="flex items-start justify-between">
                  <h3 className="text-2xl font-bold text-white group-hover:text-[#BFA35B] transition-colors">Anchor Band</h3>
                  <span className="text-[10px] font-mono uppercase tracking-widest text-white/30 border border-white/10 px-3 py-1">Personal</span>
                </div>
            ...
            {/* Civic Cube */}
            <a href="#/studio" className="group border border-white/10 p-8 hover:border-[#BFA35B]/50 transition-all bg-white/[0.01] hover:bg-white/[0.02]">
              <div className="space-y-6">
                <div className="flex items-start justify-between">
                  <h3 className="text-2xl font-bold text-white group-hover:text-[#BFA35B] transition-colors">Civic Cube</h3>
                  <span className="text-[10px] font-mono uppercase tracking-widest text-white/30 border border-white/10 px-3 py-1">Institutional</span>
                </div>
                <p className="text-base text-white/60 leading-relaxed">
        ...
        {/* What We’re Building */}
        <section className="space-y-10 py-12 border-t border-white/5">
          <h3 className="text-sm font-mono uppercase tracking-[0.4em] text-secondary">Protocols</h3>
            <ul className="space-y-6 text-white/70 list-none font-light text-xl">
            ...
            <p className="text-base text-white/30 max-w-lg font-mono uppercase tracking-tighter">
                Designed for enterprises, governments, and institutions operating in high-stakes environments.
            </p>
        </section>

        {/* System Status */}
        <section className="grid grid-cols-1 md:grid-cols-3 gap-12 py-12 border-y border-white/5 font-mono text-xs uppercase tracking-widest text-white/40">
            <div className="space-y-3">
            <span className="block text-secondary opacity-80 text-[12px]">Platform</span>
                <span className="text-white leading-relaxed">Prototype in active development</span>
            </div>
            <div className="space-y-3">
            <span className="block text-secondary opacity-80 text-[12px]">Hardware</span>
